...
class Locreator {
    ...
    addStarMethods(locatorId, locatorJSON, parentWebElement) {
        ...
        locatorObject[locatorId].list = () => drivex.list(locator(), this.parentElement || parentWebElement);
        ...
        locatorObject[locatorId].check = () => drivex.check(locator(), this.parentElement || parentWebElement);

        locatorObject[locatorId].uncheck = () => drivex.uncheck(locator(), this.parentElement || parentWebElement);
